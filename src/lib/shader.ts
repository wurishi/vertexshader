export default {
    'vs-header': `attribute float vertexId;
    uniform vec2 mouse;
    ...
    'history-vs': `attribute vec4 position;
    ...
    'history-fs': `precision mediump float;
    ...
    'rect-vs': `attribute vec4 position;
      uniform mat4 u_matrix;
      void main() {
        gl_Position = u_matrix * position;
      }`,
    'rect-fs': `precision mediump float;
